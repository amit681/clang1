...
int f1=25,f2=25;
int x=25,y=25,r=12;
int blx=10,bly=10,bls=10,score1=0,hs[100],i=0;
// for bars
...
int main (){
	...
	setcolor (YELLOW);
	outtextxy (90,20,"ENTER PASSWORD...");
	gotoxy(35,8);
	rectangle(230,100,350,140);
	scanf ("%d",&k);
	outtextxy (90,250,"PROCESSING ...********");
	if (d==k){
		security();
	}else{
		settextstyle(3,HORIZ_DIR,7);
		setcolor (9);
		outtextxy (110,330,"INVALID USER");
		getch();
	}
return 0;
}
...
int screen(){
	...
	button(250,250,400,300,"Highscore");
	...
	while(1){
		...
		if(click(250,200,400,250,"Introduction")==0){
			hidemp();
			instruction();
			return 0;
		}
		if(click(250,250,400,300,"Highscore")==0){
			hidemp();
			cleardevice();
			logo();
			return 0;
